...
# message = [b"Welcome aboard, Device 1 is now connected", b"Welcome, Device 1 is now online", b"Welcome, Device 1 is powered up and ready", b"hello from device 1"]
...
def send_message_to_all_channels():
    #message = data
    payload = create_custom_payload(device_id, message_id, message, status_code)
